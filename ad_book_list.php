                ...
                <div class="table-box">
                    <div class="row">
                        ...
                        while ($row = mysqli_fetch_array($res_data)) {
                            ...
                            echo "<tbody>";
                            echo "  <tr>";
                            echo "  <td><a href=ad_book_detail.php?bookID=" . $row['bookID'] . "><img src='$imageURL'></a></td>";
                            echo "  <td><a style=text-decoration:none;color:Black; href=ad_book_detail.php?bookID=" . $row['bookID'] . ">" . $row['bookName'] . "</a></td>";
                            echo "  <td>" . $row['bookTypeName'] . "</td>";
                            echo "  <td>" . $row['author'] . "</td>";
                            echo "  <td>" . $row['publisher'] . "</td>";
                            echo "  <td>" . $row['bName'] . "</td>";
                            echo "<td><button class='btn btn-danger'><a style=text-decoration:none;color:White; href=book_del.php?bookID=$bookID>Delete</a></button></td>";
                            echo "<td><button class='btn btn-primary'><a style=text-decoration:none;color:White; href=ad_book_edit.php?bookID=$bookID>Edit</a></button></td>";
                            echo " </tr>";
                            echo "</tbody>";
                        }
                        mysqli_close($conn);
