...
?>
    ...
    <body>
        ...
        <div class="container">
            <div class="wrapper ">
                <div class="login-box ">
                    <h1 style="color:darkgreen">Add Book success</h1>
                    <button class="btn btn-primary"><a style="text-decoration: none; color:white" href="ad_book_list.php">Go to BookList</a></button>
                </div>
            </div>
        </div>
    </body>
