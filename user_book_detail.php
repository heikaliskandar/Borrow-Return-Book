                ...
                <div class="detail-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 border border-dark rounded rounded-2">
                            ...
                            <button class='btn btn-success'><a style='text-decoration:none; color:White;' href=add_borrow.php?bookID=<?php echo $bookID ?>>borrow</a></button></td>
                            <button class="btn btn-warning"><a style="color:White; text-decoration: none;"href="user_book_list.php">Go Back</a></button>
                        </div>
                    </div>
                    <?php
                    mysqli_close($conn);
