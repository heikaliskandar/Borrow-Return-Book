        ...
        <header class="navi">
            ...
            <nav>
                <ul class="nav__links">
                    ...
                    <li><a href="user_return.php"> Return Book</a></li>
                </ul>
            </nav>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="d-flex justify-content-center">
                                <button class="btn btn-success"><a style="text-decoration:none;color:White;" href="user_edit.php">edit profile</a></button>
                            </div>
                        </div>
                        <div class="col-6">
