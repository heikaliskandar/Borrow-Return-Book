                ...
                <div class="row">
                    ...
                    while ($row = mysqli_fetch_array($res_data)) {
                        if ($row['bName'] == "Available") {
                            ...
                            echo "<td><button class='btn btn-primary'><a style=text-decoration:none;color:White; href=add_borrow.php?bookID=" . $row['bookID'] . ">Borrow</a></button></td>";
                            echo "</tr>";
                            echo "</tbody>";
                        } else {
                            $imageURL = 'assets/img/book/' . $row['bookIMG'];
