                ...
                <div class="edit-box ">
                    ...
                    <form method="post" action="user_save.php">
                        <div class="form-group">
                                ...
                                <input type="hidden" name="memberID" value="<?php echo $ID ?>"><?php echo $ID ?><br>
                                <label class="control-label">Firstname</label>
                                <input type="text" class="form-control" name="fname" required value="<?php echo $row["Firstname"]; ?>">
                                <label class="control-label">Lastname</label>
                                <input type="text" class="form-control" name="lname" required value="<?php echo $row["Lastname"]; ?>">
                                ...
                                <input type="email" class="form-control" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" value="<?php echo $row["Email"]; ?>">
                                <label class="control-label">Phone Number</label>
                                <input type="tel" class="form-control" name="phone" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" value="<?php echo $row["Tel"]; ?>">
                                ...
                                <input type="password" class="form-control" name="password" required value="<?php echo $row["Password"]; ?>"><br>
                                <div class="d-flex justify-content-center">
                                    ...
                                    <button class="btn btn-warning"><a style="color:White; text-decoration: none;"href="user_home.php">Go Back</a></button>
                                </div>
                        </div>
                    </form>
                </div>
