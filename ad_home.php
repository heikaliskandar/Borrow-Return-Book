        ...
        <div class=" container">
            <div class="wrapper ">
                <div class="edit-box ">
                    ...
                    <h5>Welcome to My Library Management</h5>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="d-flex justify-content-center mt-2">
                                <a href="ad_add_book_type.php"><button class="btn btn-primary">Add Book Type</button></a>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex justify-content-center">
                                <a href="admin_edit.php"><button class="btn btn-success">Admin</button></a>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-6">
                            <div class="d-flex justify-content-center mt-2">
                                <a href="ad_register.php"><button class="btn btn-secondary">Register Admin</button></a>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex justify-content-center mt-2">
                                <a href="ad_info.php"><button class="btn btn-dark">Show Info</button></a>
                            </div>
                        </div>
                    </div>
                </div>
